...
class Game(ndb.Model):
    ...
    game_name = ndb.StringProperty(required=True, default='Nerd Pub Trivia')
...
class Question(ndb.Model):
    ...
    multiplier = props.MultiplierProperty(required=True,default=1)
...
class bid(db.Model):
    ...
    correct = ndb.BooleanProperty(required=True,default=False)
